        ...
        .run(['$templateCache', function ($templateCache) {
                ...
                $templateCache.put('ticketMaster', '' +
                    ...
                    '<div ng-controller="BingoTicket">' +
                        '<h2> {{checkWinners.lineMessage}}</h2>' +
                        '<h2> {{checkWinners.houseMessage}}</h2>' +
                    '</div>'+
                    ...
                    '<div class="square border centreText {{ticketCreation.isASquare($parent.$index, $index)| SpaceFilter}}"> {{ticketCreation.isASquare($parent.$index, $index)}}' +
                    '</div>'+
                    '</div>'+
                    '</div>'+
                    '</div>'
